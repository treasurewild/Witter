...
function App() {
    ...
    //         errorObject.message = `There was a problem getting the wits: ${extDataCallResult.error.message}`;
    ...
    // const getWits = async () => {
    //     try {
    //         const res = await axios.get(process.env.REACT_APP_WITS_URL).then(res => { console.log(res.data) });
    //         setWits(res.data);
